...
| -------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| CPU                              | CPU        | Use CPU only                                                                                                                                                           | [OVMS Parameters](https://docs.openvino.ai/2025/model-server/ovms_docs_parameters.html)                         |
| GPU                              | GPU        | Use default GPU                                                                                                                                                        | [OVMS Parameters](https://docs.openvino.ai/2025/model-server/ovms_docs_parameters.html)                         |
...
| Automatic Device Selection       | AUTO       | Allow OpenVINO to automatically select the optimal device for inferencing                                                                                              | Possibly depricated?                                                                                 |
| Heterogeneous Execution          | HETERO     | Allows OpenVINO to execute inference on multiple devices                                                                                                               | [Heterogeneous Execution](https://docs.openvino.ai/2025/openvino-workflow/running-inference/inference-devices-and-modes/hetero-execution.html) |
